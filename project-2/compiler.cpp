...
public:
    ...
    CM(char type, const string& id) : CMType(type), id(id), input1(nullptr), input2(nullptr), output(nullptr), 
    outputComputed(false), computationFailed(false), rows(0), cols(0), outputCounter(0) {}
